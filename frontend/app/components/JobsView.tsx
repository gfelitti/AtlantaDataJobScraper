...
export default function JobsView({ initialJobs, companiesCount }: Props) {
    ...
    <div className="min-h-screen flex flex-col">
      <header className="px-4 py-3 bg-gray-900 text-white flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-400">Data-role postings — {companiesCount} Atlanta companies</p>
        </div>
